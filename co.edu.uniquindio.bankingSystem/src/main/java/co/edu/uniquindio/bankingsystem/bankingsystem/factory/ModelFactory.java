...
public class ModelFactory {
    ...
    private void initCustomer() {
        ...
        account8.setBalance(700000);
        account8.setBalance(800000);
        account9.setBalance(900000);
        account10.setBalance(400000);
        account11.setBalance(400000);
        account12.setBalance(450000);
        account13.setBalance(550000);
        account14.setBalance(780000);
